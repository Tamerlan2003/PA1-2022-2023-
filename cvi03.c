...
int main() {
    ...
    (MinuteOne >= 60 ) || (SekundOne >= 60) || (mSekOne >= 1000)|| (HourOne < 0) || (MinuteOne < 0) || (SekundOne <0) || (mSekOne < 0) ) {
        printf("Nespravny vstup.\n");
        return 1;
    }
    printf("Zadejte cas t2:\n");
    if (scanf(" %d : %d : %d , %d", &HourTwo, &MinuteTwo, &SekundTwo, &mSekTwo) != 4 || (HourTwo >= 24) ||
        (MinuteTwo >= 60) || (SekundTwo >= 60) || (mSekTwo >= 1000) || (HourTwo < 0) || (MinuteTwo < 0) || (SekundTwo <0) || (mSekTwo < 0)) {
        printf("Nespravny vstup.\n");
        return 1;
    }
    ...
    if(secondconvertedtime < firstconvertedtime)
    {
        printf("Nespravny vstup.\n");
        return 1;
    }
